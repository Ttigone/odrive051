...
#ifdef __MAIN_CPP__
const float fet_thermistor_poly_coeffs[] = {363.93910201f, -462.15369634f,
                                            307.55129571f, -27.72569531f};
...
const BoardHardwareConfig_t hw_configs[2] = {
     ...
     .gate_driver_config =
         {
             ...
             .nCS_pin = M0_nCS_Pin,
             .nFAULT_port = nFAULT_GPIO_Port,  // the nFAULT pin is shared
                                               // between both motors
    ...
    {// M1
     ...
     .gate_driver_config = {
         ...
         .nCS_pin = M1_nCS_Pin,
         .nFAULT_port =
             nFAULT_GPIO_Port,  // the nFAULT pin is shared between both motors
         .nFAULT_pin = nFAULT_Pin,
     }}};
#endif
